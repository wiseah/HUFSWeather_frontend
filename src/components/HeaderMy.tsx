...
const HeaderMy = () => {
  return (
    <header className=" bg-cyan-200 font-GangwonBold">
      ...
      <div className="container pt-2 pb-2">
        <div className="flex flex-row">
          ...
          <div className="flex flex-row w-5/6 text-5xl">
            <div className="mt-2 text-rose-600">오</div>
            <img className="w-12 h-12 " src={thermometer} alt="온도계" />
            <div className="mt-2 text-black">상청</div>
          </div>
        </div>
        <div className="flex flex-row">
          <div className="w-1/6"></div>
          <div className="flex flex-row w-5/6 text-xs font-GmarketLight">
